...
function MyShoppingList({ shoppingList, addToShoppingList, deleteFromShoppingList }) {
    ...
    return(
        <>
            ...
            <Input className={`shopping-list__add-input${inputItem === '' && `--empty`}`} type='text' id='shoppingItem' name='shoppingItem' placeholder='Enter an item to your shopping list' onChange={handleChange} value={inputItem}></Input>
            </div>
            </Popover>
