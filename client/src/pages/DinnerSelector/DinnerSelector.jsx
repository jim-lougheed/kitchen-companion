...
function DinnerSelector({ ingredients, match: { params } }) {
   ...
   const fillWheel = () => {
    window.winwheel = new Winwheel({
        ...
        segments: 
          [
              {fillStyle: '#FBF46D', text: ('111111111111111111111111111111').substring(0,20)+'...'},
              {fillStyle: '#77E4D4', text: ('222222222222222222222222222').substring(0,20)+'...'},
              {fillStyle: '#B4FE98', text: ('33333333333333333333333333333').substring(0,20)+'...'},
              {fillStyle: '#FBF46D', text: ('43444444444444444444444444444').substring(0,20)+'...'},
              {fillStyle: '#77E4D4', text: ('555555555555555555555555555').substring(0,20)+'...'},
              {fillStyle: '#B4FE98', text: ('666666666666666666666').substring(0,20)+'...'}
          ],
        lineWidth: 3,
