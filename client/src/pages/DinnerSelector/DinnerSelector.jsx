...
function DinnerSelector({ match: { params } }) {
  ...
  useEffect(() => {
        ...
        segments: [
          {
            id: data[2].id,
            fillStyle: "#FBF46D",
            text: `${data[2].title.substring(0, 28)}${
              data[2].title.length > 28 ? "..." : ""
            }`,
          },
          {
            id: data[6].id,
            fillStyle: "#77E4D4",
            text: `${data[6].title.substring(0, 28)}${
              data[6].title.length > 28 ? "..." : ""
            }`,
          },
          {
            id: data[11].id,
            fillStyle: "#B4FE98",
            text: `${data[11].title.substring(0, 28)}${
              data[11].title.length > 28 ? "..." : ""
            }`,
          },
          {
            id: data[13].id,
            fillStyle: "#FBF46D",
            text: `${data[13].title.substring(0, 28)}${
              data[13].title.length > 28 ? "..." : ""
            }`,
          },
          {
            id: data[16].id,
            fillStyle: "#77E4D4",
            text: `${data[16].title.substring(0, 28)}${
              data[16].title.length > 28 ? "..." : ""
            }`,
          },
          {
            id: data[19].id,
            fillStyle: "#B4FE98",
            text: `${data[19].title.substring(0, 28)}${
              data[19].title.length > 28 ? "..." : ""
            }`,
          },
        ],
        lineWidth: 3,
    ...
    //Retrieve recipes to populate winwheel
    axios
    ...
    <>
      ...
      <div className="dinner-wheel__container">
        <canvas
          ...
          height="500"
          onClick={startSpin}
          className="dinner-wheel__wheel"
        >
          Canvas not supported, use another browser.
        </canvas>
        {winningRecipe && (
          <div className="dinner-wheel__winning-segment">
            <p className="dinner-wheel__winning-segment-name">
              And the winner is...
            </p>
